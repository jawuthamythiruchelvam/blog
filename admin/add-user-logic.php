...
if(!empty($_SESSION['add-user'])){
   ...
   if (mysqli_query($conn, $insert_user_query)) {
    //$_SESSION['add-user-success'] = "Registration successful Destination Path: ' . $avatar_destination_path .";
    $_SESSION['add-user-success'] = "$firstname $lastname added successful ";
